...
public class PlayerControll : MonoBehaviour
{
    ...
    void moveRight()
    {
        ...
        //        rb.linearVelocity = new Vector3(-1 * moveSpeed, 0, 0);
    ...
    {
        animator.SetInteger("State", 1); // Walk animations
        rb.linearVelocity = new Vector3(0, moveSpeed, 0);
        //switch (kindCharacter)
        //{
        //    case KindCharacter.Chibick:
        //        rb.linearVelocity = new Vector3(0, moveSpeed, 0);
        ...
        //    case KindCharacter.Goose:
        //        rb.linearVelocity = new Vector3(0, -1 * moveSpeed, 0);
